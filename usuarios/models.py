...
class UserProfile(models.Model):
    ...
    mascotas = models.ManyToManyField('Mascota', blank=True, related_name="usuarios_perfiles")
...
class Mascota(models.Model):
    ...
    tipo_mascota = models.CharField(max_length=30, choices=[('perro', 'Perro'), ('gato', 'Gato'), ('otro', 'Otro')])
...
class ProfesionalUser (models.Model):
    ...
    def __str__(self):
        return f"{self.usuario.first_name} - {self.nombre_establecimiento}"
